...
import { Zap, ThumbsUp, Github, Mail, Linkedin, Twitter, CircleDot, Globe } from 'lucide-react';
...
export default function Page() {
  ...
  // Calculate matchData directly from userProjects without additional filtering
  const matchData = useMemo(() => {
    if (currentUser && userProjects.length > 0) {
      return calculateUserMatchStrength(currentUser, userProjects);
    }
    return { matchStrength: 0, expertiseLevel: null };
  }, [currentUser, userProjects, calculateUserMatchStrength]);
        ...
        <div className="px-6 relative">
          ...
          <div className="mb-4 pt-2">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Based on {userProjects.length} projects and skills matched
            </p>
          </div>
